...
def prepare_deployment(version_one):
    local('python manage.py test bacb_project')
    local('git add -p && git commit') # or local('hg add && hg commit')
    
from fabric.api import lcd, local

def deploy():
    with lcd('/Users/andyburghardt/Dropbox/Development/django/bacb_project'):

        # With git...
        local('git pull /Users/andyburghardt/Dropbox/Development/dev/django/bacb_project')
>>>>>>> 0c05fc049fe7fb891e31ef6648e0e80683aa69b1
